                    ...
                    <div class="panel-body">
                        {{Form::open(['route' => 'offer.store', 'id'=>'formSuggestion'])}}     
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input disabled class="form-control" name="nombre" placeholder="Nombre" value="{{$numeracion}}" maxlength="50">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group input-group">
                                                        ...
                                                        <input class="form-control" name="cantidad[1]" id="cantidad_1" placeholder="Cantidad" maxlength="3">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group input-group">
                                                        ...
                                                        <input disabled type="text" class="form-control" name="precio[1]" id="precio_1" placeholder="Precio unitario">
                                                    </div>
                                                </div>
                                            </div>  
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group input-group">
                                                        <span class="input-group-addon">S/</span>
                                                        <input disabled type="text" class="form-control" name="descuento[1]" id="descuento_1" placeholder="Descuento">
                                                    </div>
                                                </div>
                                            </div>  
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group input-group">
                                                        <span class="input-group-addon">S/</span>
                                                        <input disabled type="text" class="form-control" name="total[1]" id="total_1" placeholder="Total">
                                                    </div>
                                                </div>
                                            </div>                                
                                        </div>                                         
                            ...
                            <div class="row">
                                <div class="pull-right col-lg-3"> 
                                    <div class="form-group">                                   
                                        <input disabled class="form-control" name="sub_total" id="sub_total" placeholder="Sub Total" maxlength="50">
                                    </div>
                                </div>
                                <div class="pull-right col-lg-1">
                            ...
                            <div class="row">
                                <div class="pull-right col-lg-3"> 
                                    <div class="form-group">                                   
                                        <input disabled class="form-control" name="igv" id="igv" placeholder="IGV" maxlength="50">
                                    </div>                                   
                                </div>    
                                <div class="pull-right col-lg-1">
                                    <label>IGV</label>
                            ...
                            <div class="row">
                                <div class="pull-right col-lg-3"> 
                                    <div class="form-group">                                   
                                        <input disabled class="form-control" name="total" id="total" placeholder="Total" maxlength="50">
                                    </div>                                   
                                </div>    
                                <div class="pull-right col-lg-1">
                                    <label>Total</label>
            ...
            ' <div class="row promoLine"> ' +                                                           
                ...
                ' <div class="col-lg-2">' +
                    ' <div class="form-group">' +                        
                        ' <div class="form-group input-group">' +
                            ' <span class="input-group-addon"> u </span>' +
                            ' <input class="form-control" name="cantidad[' + n + ']" id="cantidad_' + n + '" placeholder="Cantidad" maxlength="3">' +
                        ' </div>' +
                    ' </div>' +
                ' </div>' +
                '<div class="col-lg-2"> ' +
                    ' <div class="form-group"> ' +                        
                        ' <div class="form-group input-group"> ' +
                            ' <span class="input-group-addon">S/</span> ' +
                            ' <input disabled type="text" class="form-control" name="precio[' + n +']" id="precio_' + n +'" placeholder="Precio unitario"> ' +
                        ' </div> '+
                    ' </div> '+
                ' </div>  '+
                ' <div class="col-lg-2">' +
                    ' <div class="form-group">' +                        
                        ' <div class="form-group input-group">' +
                            ' <span class="input-group-addon">S/</span>' +
                            ' <input type="text" disabled class="form-control" name="descuento[' + n +']" id="descuento_' + n + '" placeholder="Descuento">' +
                        ' </div>' +
                    ' </div>' +
                ' </div>' +                                
                '<div class="col-lg-2"> ' +
                    ' <div class="form-group"> ' +                        
                        ' <div class="form-group input-group"> ' +
                            ' <span class="input-group-addon">S/</span> ' +
                            ' <input disabled type="text" class="form-control" name="total[' + n +']" id="total_' + n + '" placeholder="Total">' +
                        ' </div> '+
                    ' </div> '+
                ' </div> ' +
            ' </div>' 
    ...
    $("body").on('change', "[id^='product_']", function(){        
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#descuento_' + id).attr("value", data.descuento);                        
                $('#total_' + id).attr("value", data.precio - data.descuento);   
                calcularTotal();
            }
        });    
    });
