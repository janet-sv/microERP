...
<section class="home-container">    
        <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Pedido ventas</h1>
                </div>
                <!-- /.col-lg-12 -->
        </div>
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">                        
                        {{Form::open(['route' => ['salesorder.update', $salesorder->id], 'id'=>'formSuggestion'])}}
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label>Numeración</label>
                                        <input value="{{$salesorder->numeracion}}" readonly="readonly" class="form-control" name="numeracion" maxlength="50">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                            ...
                                            @foreach($customers as $customer)
                                                @if($salesorder->customer)                                    
                                                    @if($customer->tipo_contribuyente == 1)
                                                        <option value="{{$customer->id}}" @if($customer->id==$salesorder->customer->id) selected @endif > {{$customer->nombre}} {{$customer->apellido_paterno}} - {{$customer->numero_documento}}</option>                                    
                                                    @else
                                                        <option value="{{$customer->id}}" @if($customer->id==$salesorder->customer->id) selected @endif > {{$customer->razon_social}} - {{$customer->ruc}}</option>                                    
                                                    @endif
                                                @else
                                                    @if($customer->tipo_contribuyente == 1)
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <div class="input-group date" id="fecha_inicio">
                                        <input value="{{$salesorder->fecha_creacion}}" type="text" class="form-control input-date" name="fecha_creacion" placeholder="aaaa-mm-dd" maxlength="10" required/>
                            ...
                            <div class="row">                                
                                <div class="col-lg-6"> 
                                    <label>Detalle de pedido venta</label>                                                                          
                                    <div class="form-group"> 
                            ...
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-body">                                                                                   
                                    <div id="promotion">
                                        ...
                                        <div class="row">  
                                            <input hidden name="idsalesorderdetail[{{$key+1}}]" value="{{$salesorder->salesorderdetails[$key]->id}}"></input>                                                          
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="categoryproduct[{{$key+1}}]" id="categoryproduct_{{$key + 1}}">                                           
                                                        ...
                                                        @foreach($categoryproducts as $categoryproduct)                                    
                                                            <option value="{{$categoryproduct->id}}" @if($categoryproduct->id==$salesorder->salesorderdetails[$key]->product->category->id) selected @endif >{{$categoryproduct->name}}</option>                                    
                                                        @endforeach  
                                                    </select>
                                                </div>
                                            </div>                                   
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group input-group">
                                                        ...
                                                        <input value="{{$salesorder->salesorderdetails[$key]->cantidad}}" max="999" type="number" class="form-control" name="cantidad[{{$key+1}}]" id="cantidad_{{$key + 1}}" placeholder="Cantidad" >
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group input-group">
                                                        ...
                                                        <input readonly="readonly" value="{{$salesorder->salesorderdetails[$key]->precio_unitario}}" type="text" class="form-control" name="precio[{{$key+1}}]" id="precio_{{$key + 1}}" placeholder="Precio unitario">
                                                    </div>
                                                </div>
                                            </div>  
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group input-group">
                                                        <span class="input-group-addon">S/</span>
                                                        <input readonly="readonly" value="{{$salesorder->salesorderdetails[$key]->descuento}}" type="text" class="form-control" name="descuento[{{$key+1}}]" id="descuento_{{$key + 1}}" placeholder="Descuento">
                                                    </div>
                                                </div>
                                            </div>  
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group input-group">
                                                        <span class="input-group-addon">S/</span>
                                                        <input readonly="readonly" value="{{$salesorder->salesorderdetails[$key]->total}}" type="text" class="form-control" name="total[{{$key+1}}]" id="total_{{$key + 1}}" placeholder="Total">
                                                    </div>
                                                </div>
                                            </div>                                
                                        </div> 
                            ...
                            <div class="row">
                                <div class="pull-right col-lg-3"> 
                                    <div class="form-group">                                   
                                        <input value="{{$salesorder->descuento_manual}}" class="form-control" name="descuento_manual" id="descuento_manual" placeholder="Descuento Manual" maxlength="7">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="pull-right col-lg-3"> 
                                    <div class="form-group">                                   
                                        <input value="{{$salesorder->sub_total}}" readonly="readonly" class="form-control" name="sub_total" id="sub_total" placeholder="Sub Total" maxlength="50">
                                    </div>
                                </div>
                                <div class="pull-right col-lg-1">
                            ...
                            <div class="row">
                                <div class="pull-right col-lg-3"> 
                                    <div class="form-group">                                   
                                        <input value="{{$salesorder->igv}}" readonly="readonly" class="form-control" name="igv" id="igv" placeholder="IGV" maxlength="50">
                                    </div>                                   
                                </div>    
                                <div class="pull-right col-lg-1">
                                    <label>IGV</label>
                            ...
                            <div class="row">
                                <div class="pull-right col-lg-3"> 
                                    <div class="form-group">                                   
                                        <input value="{{$salesorder->total}}" readonly="readonly" class="form-control" name="total_pedido_venta" id="total_pedido_venta" placeholder="Total" maxlength="50">
                                    </div>                                   
                                </div>    
                                <div class="pull-right col-lg-1">
                                    <label>Total</label>
...
$(document).ready(function($) {
    ...
    @foreach( $salesorderdetails as $key => $salesorderdetail)
        $.ajax({
            ...
            data: {
                ...
                idProduct: {{$salesorder->salesorderdetails[$key]->product->id}},
            },
    ...
    var n={{count($salesorderdetails)}} + 1;
    var igv = 1.18;
    ...
    $("#add").click(function() {
        ...
        $("#promotion").append('' +  
            ' <div class="row promoLine"> ' + 
                ' <input hidden name="idsalesorderdetail[' + n + ']" value="0"></input>' +
                ' <div class="col-lg-2"> ' +
                    ' <div class="form-group"> ' +                        
    ...
    $("#remove").click(function() {
        ...
        if (typeof x !== typeof undefined && x !== false) {return;  }
        if(n=={{count($salesorderdetails)}} +1 ){return}
    ...
    function calcularTotal(){
        ...
        $('#total_proforma').attr("value", parseFloat(total).toFixed(2) ); 
    }
});
