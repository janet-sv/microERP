...
<section class="logistic-container">
    ...
    <div class="row">
    	<div class="col-sm-12">
    		<form class="form-horizontal" role="form" method="POST" action="{{ route('logistic.product_category.update', ['id' => $category->id]) }}">
    			<input type="hidden" name="_token" value="{{ csrf_token() }}">
			  	...
			  	<div class="form-group{{ $errors->has('abrCode') ? ' has-error' : '' }}">    	
			    	...
			    	<div class="col-xs-12 col-sm-6 col-md-5">
			      		<input type="text" class="form-control" name="abrCode" value="@if(old('abrCode')){{ old('abrCode') }}@else{{ $category->code }}@endif" maxlength="3" readonly>
